...
\title[Cassini Radar]
{\vspace{70pt}
The Radar instrument on-board Cassini}
%\subtitle{Mini-project RSPS}
%\pdforstring{}{}
\author[Yann Chemin]
{\vspace{40pt}\\
RS of Planetary Surfaces}

\institute[BBK]
{B.Sc. Planetary Sciences with Astronomy \\
 \vspace{5pt}
 $4^{th}$ Year,  Remote Sensing of Planetary Surfaces
\begin{center}
 \includegraphics[width=2.5cm]{Birkbeck}
\end{center}
}
\date{\tiny \textcolor{white}{December 1$^{st}$, 2014}}
...
\hypersetup{%
    ...
    pdfkeywords={Cassini, RADAR, Titan, methane, ethane, cycle, rainfall, evaporation, run-off, erosion, climate}
}
...
\section{Titan}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]{Cassini}
\begin{block}{Cassini RADAR}
 http://saturn.jpl.nasa.gov/spacecraft/cassiniorbiterinstruments/instrumentscassiniradar/instcassiniradardetails/
\end{block}
