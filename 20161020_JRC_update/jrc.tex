...
\title[JRC\hspace{2em}\insertframenumber/\inserttotalframenumber]{MonSTERS `R' us}
...
\begin{frame}
  \frametitle{HPC-EOSSSD}
\begin{center}
\begin{itemize}
 \item Dockerfile Debian:testing
 \item FIJI (ImageJ v2)
 \item GRASS-SVN compilation on build (v7.3)
  \item /eos/jeodpp/data/CANHEMON
 \item Use the CanHeMon scripts with it
 \item Building Docker image on TESLA 
