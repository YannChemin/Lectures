...
\newpage
\section{T\'el\'ed\'etection}
\label{remote_sensing}

\subsection{Import}
\label{Import}

Allez sur le site du GLCF pour se fournir en image Landsat pour votre site d'\'etude. 
Regardez le Path et Row que vous avez besoin: \href{https://landsat.usgs.gov/sites/default/files/images/wrs2nb.gif}{landsat.usgs.gov/sites/default/files/images/wrs2nb.gif}.

%\setkeys{Gin}{width=1\textwidth}
\begin{figure}[htbp]
   \centering
   %name of your graphic, without the path AND in PNG (screnshots etc)/PDF (drawings) format:
   \includegraphics[scale=0.1]{wrs2nb}
   %caption of the figure
...
Au lancement, tapez ``landsat'' ou le nom que vous avez cr\'e\'e.
...
Changez les couleurs des couches R=3, G=2 et B=1 en fonction de r.landsat.rgb:
...
Chargez la carte sur le canevas (real color composite)
...
Chargez la carte de la false color composite
